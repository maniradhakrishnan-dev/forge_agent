...
class MatingContext(BaseModel):
    ...
    partner_id: str
    mate_type: Literal["hole_shaft", "shaft_hole", "face_face", "slot_tab", "gear_mesh", "edge_edge"]
...
class InterfacePort(BaseModel):
    ...
    feature_type: Literal["hole", "shaft", "face", "slot", "gear_mesh", "edge", "pin", "gear"] = "face"
...
class RepairInstruction(BaseModel):
    ...
    target_agent: Literal["code_generator_agent", "assembly_agent", "planner_agent"]
    target_part_id: str
    fault_type: Literal["dfm", "geometry", "positioning"]
